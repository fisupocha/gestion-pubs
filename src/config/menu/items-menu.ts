export const itemInicio = { href: "/", label: "Inicio" };

export const itemsOperativa = [
  { href: "/facturas-recibidas", label: "Facturas recibidas" },
  { href: "/notas-varias", label: "Notas varias" },
