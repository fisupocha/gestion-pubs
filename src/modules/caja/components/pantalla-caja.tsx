...
function Bloque({
  ...
  return (
    <section
      className={`rounded-[22px] border border-[#a8afb5] bg-[linear-gradient(180deg,rgba(242,244,245,0.99)_0%,rgba(227,231,234,0.99)_100%)] p-3 shadow-[0_16px_34px_rgba(56,61,68,0.10)] 2xl:rounded-[24px] 2xl:p-4 2xl:shadow-[0_20px_40px_rgba(56,61,68,0.12)] ${className}`}
    >
      <div className="mb-2 text-center text-[10px] font-black uppercase tracking-[0.22em] text-[#6b747e] 2xl:mb-3 2xl:text-[11px] 2xl:tracking-[0.24em]">
        {titulo}
      </div>
      {children}
    </section>
...
function Campo({
  ...
  return (
    <label className="grid gap-1.5">
      <span className="text-center text-[10px] font-bold uppercase tracking-[0.08em] text-[#6d747c] 2xl:text-[11px] 2xl:tracking-[0.1em]">
        {label}
      </span>
      {children}
    </label>
...
const inputClassName =
  "w-full rounded-2xl border border-[#c4c9ce] bg-[linear-gradient(180deg,#fcfcfd_0%,#eef1f3_100%)] px-3 py-2 text-center text-sm text-[#252b31] shadow-[inset_0_1px_0_rgba(255,255,255,0.86),0_6px_14px_rgba(56,61,68,0.05)] outline-none transition placeholder:text-[#949ca4] focus:border-[#818b95] focus:bg-white focus:shadow-[0_0_0_3px_rgba(129,139,149,0.14)] 2xl:py-2.5";

const accionClassName =
  "min-w-[54px] rounded-2xl border border-[#bcc2c8] bg-[linear-gradient(180deg,#fafbfc_0%,#e3e7ea_100%)] px-3 py-2 text-center text-sm font-semibold text-[#313940] shadow-[0_10px_18px_rgba(56,61,68,0.10)] transition hover:border-[#8d959d] hover:bg-[#f2f4f6] 2xl:min-w-[60px] 2xl:py-2.5";
...
export function PantallaCaja({
  ...
  function obtenerCamposBusqueda(registro: RegistroFactura) {
    ...
    const totalCajaRegistro = round2(parseDecimal(registro.base10));
    const totalBaseRegistro = round2(totalCajaRegistro / 1.1);
    const totalIvaRegistro = round2(totalCajaRegistro - totalBaseRegistro);
  ...
  return (
    <section className="flex h-full min-h-0 flex-col gap-2 p-2.5 2xl:gap-2.5 2xl:p-3">
      <header className="flex items-center justify-between rounded-[22px] border border-[#a8afb5] bg-[linear-gradient(180deg,#f1f4f5_0%,#e2e7ea_100%)] px-3 py-1 shadow-[0_16px_34px_rgba(56,61,68,0.10)] 2xl:rounded-[24px] 2xl:px-4 2xl:py-1.5 2xl:shadow-[0_18px_38px_rgba(56,61,68,0.12)]">
        <div className="w-[48px] shrink-0 2xl:w-[56px]" />

        <div className="flex-1 text-center">
          <h1 className="text-[18px] font-black tracking-tight text-[#2c343b] 2xl:text-[20px]">
            Caja
          </h1>
        </div>

        <div className="rounded-2xl border border-[#a8afb5] bg-[linear-gradient(180deg,#f5f7f8_0%,#e6eaed_100%)] px-2 py-0.75 text-center shadow-[0_10px_18px_rgba(56,61,68,0.10)] 2xl:px-2.5 2xl:py-1">
          <div className="text-[8px] font-black uppercase tracking-[0.2em] text-[#6b747e]">
            ID
          </div>
          <div className="text-base font-black text-[#2c343b] 2xl:text-lg">{idVisible}</div>
        </div>
      </header>
        ...
        <div className="relative grid min-h-0 gap-2.5 2xl:gap-3">
          ...
          <Bloque titulo="Bases e importes">
            ...
            <div className="mt-2 grid gap-2 lg:grid-cols-[1fr_1fr_1.08fr] 2xl:mt-2.5 2xl:gap-2.5 2xl:grid-cols-[1fr_1fr_1.1fr]">
              <div className="rounded-2xl border border-[#b3bac0] bg-[linear-gradient(180deg,#f1f4f5_0%,#dde2e5_100%)] px-3.5 py-1.5 text-center shadow-[0_12px_22px_rgba(56,61,68,0.10)] 2xl:px-4 2xl:py-2">
                <div className="text-center text-[11px] font-black uppercase tracking-[0.16em] text-[#687079]">
                  Total base
                </div>
                <div className="mt-0.5 text-center text-[18px] font-black text-[#333d44] 2xl:text-[22px]">
                  {fmtMoney(totalBase)} EUR
                </div>
              </div>

              <div className="rounded-2xl border border-[#98a6b0] bg-[linear-gradient(180deg,#ebeff2_0%,#d1d9de_100%)] px-3.5 py-1.5 text-center shadow-[0_12px_22px_rgba(62,75,84,0.11)] 2xl:px-4 2xl:py-2">
                <div className="text-center text-[11px] font-black uppercase tracking-[0.16em] text-[#546a76]">
                  Total IVA
                </div>
                <div className="mt-0.5 text-center text-[18px] font-black text-[#375160] 2xl:text-[22px]">
                  {fmtMoney(totalIva)} EUR
                </div>
              </div>

              <div className="rounded-2xl border border-[#7f909d] bg-[linear-gradient(180deg,#dfe6eb_0%,#b8c3cb_100%)] px-3.5 py-1.5 text-center shadow-[0_14px_26px_rgba(62,74,84,0.16)] 2xl:px-4 2xl:py-2">
                <div className="text-center text-[11px] font-black uppercase tracking-[0.18em] text-[#495c69]">
                  Total caja
                </div>
                <div className="mt-0.5 text-center text-[22px] font-black text-[#324653] 2xl:text-[26px]">
                  {fmtMoney(totalCaja)} EUR
                </div>
              </div>
            </div>

            <div className="mt-4 rounded-[20px] border border-[#a8afb5] bg-[linear-gradient(180deg,rgba(243,245,246,0.96)_0%,rgba(227,231,234,0.99)_100%)] px-3 py-3 shadow-[0_14px_26px_rgba(56,61,68,0.09)] 2xl:mt-5 2xl:px-4 2xl:py-4">
              <div className="flex flex-wrap items-center justify-center gap-2">
                ...
                <div className="min-w-[80px] rounded-2xl border border-[#bcc2c8] bg-[linear-gradient(180deg,#fafbfc_0%,#e3e7ea_100%)] px-3 py-2 text-center text-sm font-black text-[#313940] shadow-[0_10px_18px_rgba(56,61,68,0.10)] 2xl:min-w-[88px] 2xl:px-4 2xl:py-2.5">
                  ID {idVisible}
                </div>
                  ...
                  className={
                    botonGuardado
                      ...
                      : !formularioValido
                        ...
                        : "min-w-[124px] rounded-2xl border border-[#b6bdc3] bg-[linear-gradient(180deg,#f7f9fa_0%,#dde3e7_100%)] px-4 py-2 text-[15px] font-semibold text-[#313940] shadow-[0_12px_20px_rgba(56,61,68,0.10)] transition hover:bg-[#edf1f4] 2xl:min-w-[136px] 2xl:py-2.5"
                  }
                >
        ...
        <div className="relative grid min-h-0 gap-2.5 2xl:gap-3">
          <Bloque titulo="Cobro">
              ...
              <button
                ...
                className={
                  formulario.pagado
                    ...
                    : "cursor-not-allowed rounded-2xl border border-[#d1d7dc] bg-[linear-gradient(180deg,#fafbfc_0%,#eceff1_100%)] px-4 py-2 text-sm font-black text-[#8a929a] opacity-70 shadow-none 2xl:py-2.5"
                }
              >
                Cobrado
              </button>
            ...
            <div className="mt-2 grid gap-2 2xl:mt-2.5 2xl:gap-2.5">
              ...
              <div className="rounded-2xl border border-[#a8afb5] bg-[linear-gradient(180deg,#f1f4f5_0%,#dee3e6_100%)] px-3 py-2 shadow-[0_10px_18px_rgba(56,61,68,0.08)]">
                <div className="text-center text-[10px] font-black uppercase tracking-[0.16em] text-[#6b747e]">
                  Adjunto
                </div>

                <div className="mt-1 truncate text-center text-[11px] font-medium text-[#6f7880]">
                ...
                <div className="mt-2 flex items-center justify-center gap-2">
                  ...
                  <button
                    ...
                    className="rounded-xl border border-[#b6bdc3] bg-[linear-gradient(180deg,#f7f9fa_0%,#dde3e7_100%)] px-3 py-1.5 text-[11px] font-semibold text-[#313940] shadow-[0_8px_14px_rgba(56,61,68,0.10)] transition hover:bg-[#edf1f4]"
                  >
                  ...
                  <button
                    ...
                    className="rounded-xl border border-[#c1c7cc] bg-[linear-gradient(180deg,#fbfcfc_0%,#e5e8ea_100%)] px-3 py-1.5 text-[11px] font-semibold text-[#313940] shadow-[0_8px_14px_rgba(56,61,68,0.10)] transition hover:bg-[#edf1f4] disabled:cursor-not-allowed disabled:opacity-55"
                  >
                    Ver
                  </button>
          ...
          {buscadorAbierto ? (
            <div className="absolute left-1/2 top-[356px] z-40 w-[320px] -translate-x-1/2">
              <div className="rounded-[24px] border border-[#5b646d] bg-[linear-gradient(180deg,#343a41_0%,#2a2f35_48%,#1f2328_100%)] p-5 shadow-[0_24px_56px_rgba(24,28,33,0.30)]">
                <div className="text-center text-[10px] font-black uppercase tracking-[0.16em] text-[#d7dee3]">
                  Buscar
                </div>

                <div className="mt-2 grid gap-3">
                  <label className="grid gap-1.5">
                    <span className="text-[10px] font-black uppercase tracking-[0.14em] text-[#d7dee3]">
                      Texto
                    </span>
                    <input
                      ...
                      type="text"
                      className="w-full rounded-2xl border border-[#c4c9ce] bg-[linear-gradient(180deg,#fcfcfd_0%,#eef1f3_100%)] px-3 py-2 text-sm text-[#252b31] shadow-[inset_0_1px_0_rgba(255,255,255,0.86)] outline-none"
                    />
                  </label>

                  <label className="flex items-center justify-center gap-2 text-sm font-medium text-[#e8edf0]">
                    <input
                  ...
                  {mensajeBusqueda ? (
                    <div className="rounded-2xl border border-[#7a848d] bg-[rgba(249,251,252,0.92)] px-3 py-2 text-center text-sm text-[#535e67]">
                      {mensajeBusqueda}
                    </div>
                  ) : null}
                  ...
                  <div className="grid gap-2">
                    <button
                      ...
                      className="rounded-2xl border border-[#b6bdc3] bg-[linear-gradient(180deg,#f7f9fa_0%,#dde3e7_100%)] px-4 py-2 text-sm font-semibold text-[#313940] shadow-[0_10px_18px_rgba(56,61,68,0.10)]"
                    >
                      Buscar
                    </button>
                    ...
                    <button
                      ...
                      className="rounded-2xl border border-[#656f78] bg-[linear-gradient(180deg,#40474e_0%,#30363d_100%)] px-4 py-2 text-sm font-semibold text-[#e8edf0] shadow-[0_8px_16px_rgba(24,28,33,0.22)]"
                    >
                      Cerrar
                    </button>
                  </div>
      ...
      {dialogoSalida.abierto ? (
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-[rgba(22,16,12,0.38)] p-4">
          <div className="w-full max-w-md rounded-[24px] border border-[#a8afb5] bg-[linear-gradient(180deg,#f5f7f8_0%,#e2e7ea_100%)] p-5 shadow-[0_24px_56px_rgba(24,28,33,0.28)]">
            <div className="text-lg font-black text-[#211915]">No has guardado el registro</div>
            <p className="mt-2 text-sm text-[#6f7880]">
