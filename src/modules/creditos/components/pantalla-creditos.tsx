...
function Bloque({
  ...
  return (
    <section
      className={`rounded-[22px] border border-[#b5949d] bg-[linear-gradient(180deg,rgba(245,238,240,0.99)_0%,rgba(231,220,223,0.99)_100%)] p-3 shadow-[0_16px_34px_rgba(70,39,49,0.10)] 2xl:rounded-[24px] 2xl:p-4 2xl:shadow-[0_20px_40px_rgba(70,39,49,0.12)] ${className}`}
    >
      <div className="mb-2 text-center text-[10px] font-black uppercase tracking-[0.22em] text-[#7d5f67] 2xl:mb-3 2xl:text-[11px] 2xl:tracking-[0.24em]">
        {titulo}
      </div>
      {children}
    </section>
...
function Campo({
  ...
  return (
    <label className="grid gap-1.5">
      <span className="text-center text-[10px] font-bold uppercase tracking-[0.08em] text-[#7f666d] 2xl:text-[11px] 2xl:tracking-[0.1em]">
        {label}
      </span>
      {children}
    </label>
...
const inputClassName =
  "w-full rounded-2xl border border-[#ccb8be] bg-[linear-gradient(180deg,#fefcfc_0%,#f3edef_100%)] px-3 py-2 text-center text-sm text-[#34242a] shadow-[inset_0_1px_0_rgba(255,255,255,0.86),0_6px_14px_rgba(70,39,49,0.05)] outline-none transition placeholder:text-[#a38f96] focus:border-[#9f6877] focus:bg-white focus:shadow-[0_0_0_3px_rgba(159,104,119,0.14)] 2xl:py-2.5";

const accionClassName =
  "min-w-[54px] rounded-2xl border border-[#c5afb5] bg-[linear-gradient(180deg,#fbf8f9_0%,#e8dfe2_100%)] px-3 py-2 text-center text-sm font-semibold text-[#452d35] shadow-[0_10px_18px_rgba(70,39,49,0.10)] transition hover:border-[#996c78] hover:bg-[#f4eef0] 2xl:min-w-[60px] 2xl:py-2.5";

const campoDeshabilitadoClassName =
  "cursor-not-allowed border-[#d8cad0] bg-[linear-gradient(180deg,#fbf8f9_0%,#eee5e8_100%)] text-[#938188] shadow-none opacity-70";
...
export function PantallaCreditos({
  ...
  useEffect(() => {
    ...
    async function cargarPersistidos() {
      try {
        const persistidos = await listarCreditosPersistidos(clasificacionActiva);
        ...
        if (!cancelado) {
          window.alert("No se pudieron cargar los creditos guardados.");
        }
      }
    }
  ...
  const totalIva = 0;
  const totalCredito = round2(base21);
  ...
  async function guardarPrueba(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const persistido = (await guardarCreditoPersistido(
        registroActual,
        clasificacionActiva
      )) as RegistroFactura;
      ...
      window.alert("No se pudo guardar el credito en BBDD.");
    }
  }
  ...
  function obtenerCamposBusqueda(registro: RegistroFactura) {
    ...
    const totalCreditoRegistro = round2(parseDecimal(registro.base21));
  ...
  return (
    <section className="flex h-full min-h-0 flex-col gap-2 p-2.5 2xl:gap-2.5 2xl:p-3">
      <header className="flex items-center justify-between rounded-[22px] border border-[#b5949d] bg-[linear-gradient(180deg,#f4edef_0%,#e6dadd_100%)] px-3 py-1 shadow-[0_16px_34px_rgba(70,39,49,0.10)] 2xl:rounded-[24px] 2xl:px-4 2xl:py-1.5 2xl:shadow-[0_18px_38px_rgba(70,39,49,0.12)]">
        <div className="w-[48px] shrink-0 2xl:w-[56px]" />

        <div className="flex-1 text-center">
          <h1 className="text-[18px] font-black tracking-tight text-[#3d222a] 2xl:text-[20px]">
            Créditos
          </h1>
        </div>

        <div className="rounded-2xl border border-[#b5949d] bg-[linear-gradient(180deg,#f7f1f2_0%,#e9dde0_100%)] px-2 py-0.75 text-center shadow-[0_10px_18px_rgba(70,39,49,0.10)] 2xl:px-2.5 2xl:py-1">
          <div className="text-[8px] font-black uppercase tracking-[0.2em] text-[#7d5f67]">
            ID
          </div>
          <div className="text-base font-black text-[#3d222a] 2xl:text-lg">{idVisible}</div>
        </div>
      </header>
          ...
          <Bloque titulo="Bases e importes">
            ...
            <div className="mt-2 grid gap-2 lg:grid-cols-[1fr_1fr_1.08fr] 2xl:mt-2.5 2xl:gap-2.5 2xl:grid-cols-[1fr_1fr_1.1fr]">
              <div className={tarjetaDeshabilitadaClassName}>
                <div className="text-center text-[11px] font-black uppercase tracking-[0.16em] text-[#938188]">
                  Total base
                </div>
                <div className="mt-0.5 text-center text-[18px] font-black text-[#725f66] 2xl:text-[22px]">
              ...
              <div className="rounded-2xl border border-[#915766] bg-[linear-gradient(180deg,#e8d8de_0%,#cb9baa_100%)] px-3.5 py-1.5 text-center shadow-[0_14px_26px_rgba(106,53,67,0.18)] 2xl:px-4 2xl:py-2">
                <div className="text-center text-[11px] font-black uppercase tracking-[0.18em] text-[#7f223f]">
                  Total credito
                </div>
                <div className="mt-0.5 text-center text-[22px] font-black text-[#651a34] 2xl:text-[26px]">
                  {fmtMoney(totalCredito)} EUR
                </div>
              </div>
            </div>

            <div className="mt-4 rounded-[20px] border border-[#b5949d] bg-[linear-gradient(180deg,rgba(244,237,239,0.96)_0%,rgba(231,220,223,0.99)_100%)] px-3 py-3 shadow-[0_14px_26px_rgba(70,39,49,0.09)] 2xl:mt-5 2xl:px-4 2xl:py-4">
              <div className="flex flex-wrap items-center justify-center gap-2">
                ...
                <div className="min-w-[80px] rounded-2xl border border-[#c5afb5] bg-[linear-gradient(180deg,#fbf8f9_0%,#e8dfe2_100%)] px-3 py-2 text-center text-sm font-black text-[#452d35] shadow-[0_10px_18px_rgba(70,39,49,0.10)] 2xl:min-w-[88px] 2xl:px-4 2xl:py-2.5">
                  ID {idVisible}
                </div>
                  ...
                  className={
                    botonGuardado
                      ...
                      : !formularioValido
                        ...
                        : "min-w-[124px] rounded-2xl border border-[#bea5ad] bg-[linear-gradient(180deg,#faf6f7_0%,#e6d9de_100%)] px-4 py-2 text-[15px] font-semibold text-[#452d35] shadow-[0_12px_20px_rgba(70,39,49,0.11)] transition hover:bg-[#f4edef] 2xl:min-w-[136px] 2xl:py-2.5"
                  }
                >
        ...
        <div className="relative grid min-h-0 gap-2.5 2xl:gap-3">
          <Bloque titulo="Pago">
            <div className="grid gap-2.5 lg:grid-cols-[1fr_1fr] 2xl:gap-3">
              ...
              <button
                ...
                disabled
                aria-disabled="true"
                className="cursor-not-allowed rounded-2xl border border-[#d8cad0] bg-[linear-gradient(180deg,#fbf8f9_0%,#eee5e8_100%)] px-4 py-2 text-sm font-black text-[#938188] opacity-70 shadow-none 2xl:py-2.5"
              >
                No pagado
              </button>
            </div>
            ...
            <div className="mt-2 grid gap-2 2xl:mt-2.5 2xl:gap-2.5">
              ...
              <div className="rounded-2xl border border-[#b5949d] bg-[linear-gradient(180deg,#f3edef_0%,#e1d6d9_100%)] px-3 py-2 shadow-[0_10px_18px_rgba(70,39,49,0.08)]">
                <div className="text-center text-[10px] font-black uppercase tracking-[0.16em] text-[#7d5f67]">
                  Adjunto
                </div>

                <div className="mt-1 truncate text-center text-[11px] font-medium text-[#776067]">
                ...
                <div className="mt-2 flex items-center justify-center gap-2">
                  ...
                  <button
                    ...
                    className="rounded-xl border border-[#bea5ad] bg-[linear-gradient(180deg,#faf6f7_0%,#e6d9de_100%)] px-3 py-1.5 text-[11px] font-semibold text-[#452d35] shadow-[0_8px_14px_rgba(70,39,49,0.10)] transition hover:bg-[#f4edef]"
                  >
                  ...
                  <button
                    ...
                    className="rounded-xl border border-[#c6b1b7] bg-[linear-gradient(180deg,#fbf8f9_0%,#e9e0e3_100%)] px-3 py-1.5 text-[11px] font-semibold text-[#452d35] shadow-[0_8px_14px_rgba(70,39,49,0.10)] transition hover:bg-[#f4edef] disabled:cursor-not-allowed disabled:opacity-55"
                  >
                    Ver
                  </button>
          ...
          {buscadorAbierto ? (
            <div className="absolute left-1/2 top-[356px] z-40 w-[320px] -translate-x-1/2">
              <div className="rounded-[24px] border border-[#6a4f56] bg-[linear-gradient(180deg,#402d33_0%,#312328_48%,#261a1f_100%)] p-5 shadow-[0_24px_56px_rgba(30,18,23,0.30)]">
                <div className="text-center text-[10px] font-black uppercase tracking-[0.16em] text-[#e2cfd4]">
                  Buscar
                </div>

                <div className="mt-2 grid gap-3">
                  <label className="grid gap-1.5">
                    <span className="text-[10px] font-black uppercase tracking-[0.14em] text-[#e2cfd4]">
                      Texto
                    </span>
                    <input
                      ...
                      type="text"
                      className="w-full rounded-2xl border border-[#ccb8be] bg-[linear-gradient(180deg,#fefcfc_0%,#f3edef_100%)] px-3 py-2 text-sm text-[#34242a] shadow-[inset_0_1px_0_rgba(255,255,255,0.86)] outline-none"
                    />
                  </label>

                  <label className="flex items-center justify-center gap-2 text-sm font-medium text-[#f2e7ea]">
                    <input
                  ...
                  {mensajeBusqueda ? (
                    <div className="rounded-2xl border border-[#8f747b] bg-[rgba(253,248,249,0.92)] px-3 py-2 text-center text-sm text-[#664f56]">
                      {mensajeBusqueda}
                    </div>
                  ) : null}
                  ...
                  <div className="grid gap-2">
                    <button
                      ...
                      className="rounded-2xl border border-[#bea5ad] bg-[linear-gradient(180deg,#faf6f7_0%,#e6d9de_100%)] px-4 py-2 text-sm font-semibold text-[#452d35] shadow-[0_10px_18px_rgba(70,39,49,0.10)]"
                    >
                      Buscar
                    </button>
                    ...
                    <button
                      ...
                      className="rounded-2xl border border-[#74575f] bg-[linear-gradient(180deg,#4b363d_0%,#39282e_100%)] px-4 py-2 text-sm font-semibold text-[#f2e7ea] shadow-[0_8px_16px_rgba(30,18,23,0.22)]"
                    >
                      Cerrar
                    </button>
                  </div>
      ...
      {dialogoSalida.abierto ? (
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-[rgba(22,16,12,0.38)] p-4">
          <div className="w-full max-w-md rounded-[24px] border border-[#b5949d] bg-[linear-gradient(180deg,#f7f1f2_0%,#e6dadd_100%)] p-5 shadow-[0_24px_56px_rgba(30,18,23,0.28)]">
            <div className="text-lg font-black text-[#211915]">No has guardado el registro</div>
            <p className="mt-2 text-sm text-[#776067]">
