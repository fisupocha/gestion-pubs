...
const accionClassName =
  "min-w-[54px] rounded-2xl border border-[#c5afb5] bg-[linear-gradient(180deg,#fbf8f9_0%,#e8dfe2_100%)] px-3 py-2 text-center text-sm font-semibold text-[#452d35] shadow-[0_10px_18px_rgba(70,39,49,0.10)] transition duration-150 hover:-translate-y-[2px] hover:scale-[1.02] hover:border-[#6d3445] hover:bg-[#fdf8fa] hover:shadow-[0_22px_36px_rgba(70,39,49,0.22)] active:translate-y-0 active:scale-100 2xl:min-w-[60px] 2xl:py-2.5";
...
const campoFijoBloqueadoClassName =
  "pointer-events-none cursor-not-allowed appearance-none !border-[#d8cad0] !bg-[linear-gradient(180deg,#fbf8f9_0%,#eee5e8_100%)] !text-[#938188] !shadow-none opacity-70 hover:translate-y-0 hover:scale-100 hover:!border-[#d8cad0] hover:!bg-[linear-gradient(180deg,#fbf8f9_0%,#eee5e8_100%)] hover:!shadow-none focus:!border-[#d8cad0] focus:!bg-[linear-gradient(180deg,#fbf8f9_0%,#eee5e8_100%)] focus:!shadow-none";
