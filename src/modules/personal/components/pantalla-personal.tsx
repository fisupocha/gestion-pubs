...
const accionClassName =
  "min-w-[54px] rounded-2xl border border-[#d1b6ae] bg-[linear-gradient(180deg,#fdf9f8_0%,#ede1dd_100%)] px-3 py-2 text-center text-sm font-semibold text-[#492f29] shadow-[0_10px_18px_rgba(85,52,46,0.09)] transition duration-150 hover:-translate-y-[2px] hover:scale-[1.02] hover:border-[#904939] hover:bg-[#fff9f8] hover:shadow-[0_22px_36px_rgba(85,52,46,0.22)] active:translate-y-0 active:scale-100 2xl:min-w-[60px] 2xl:py-2.5";
